...
// else {
// for (i = 0; i < 5; i++)
// resultat = BoardPlayerOne[x][y + i];
// if (resultat == 0)
// for (i = 0; i < 5; i++)
// BoardPlayerOne[x][y + i] = 1;
// else
// System.exit(0);
// }
// } else if (position == 2) {
...
// else {
// for (i = 0; i < 5; i++)
// resultat = BoardPlayerOne[x + i][y];
// if (resultat == 0)
// for (i = 0; i < 5; i++)
// BoardPlayerOne[x + i][y] = 1;
// else
// System.exit(0);
// }
// }
